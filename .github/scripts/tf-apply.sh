...
function tf-apply () {
  ...
  if [ "$4" == "true" ]; then
    terraform apply -auto-approve -input=false -var-file="../customers/$2/$2.tfvars" -var-file="../customers/$2/$3/$3.tfvars"
  else
    terraform apply -auto-approve -input=false -var-file="../customers/$2/$3/$3.tfvars"
  fi
}

tf-apply $working_dir $customer_name $customer_env $create_customer_folder